========================================================================
    APLICACIÓN: Información general del proyecto Analizador
========================================================================

AppWizard ha creado esta aplicación Analizador.  

Este archivo incluye un resumen acerca del contenido de los archivos que
constituyen su aplicación Analizador.
...
StdAfx.h, StdAfx.cpp
    ...
    precompilado (PCH) denominado Analizador.pch y un archivo de 
